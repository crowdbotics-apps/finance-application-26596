  ...
  render = () => (
    <ScrollView contentContainerStyle={{ flexGrow: 1 }}>
      ...
      <View style={styles.View_1_1568}>
        <Text style={styles.Text_1_1568}>Home</Text>
      </View>
      <View style={styles.View_1_1569}>
        <Text style={styles.Text_1_1569}>Balance Sheet</Text>
      </View>
      <View style={styles.View_1_1570}>
        <Text style={styles.Text_1_1570}>Profit and Loss</Text>
      </View>
      <View style={styles.View_1_1571}>
        <Text style={styles.Text_1_1571}>Invoices</Text>
      </View>
      <View style={styles.View_1_1572}>
        <Text style={styles.Text_1_1572}>Accounts Receivables</Text>
      </View>
      <ImageBackground
        source={{
          uri:
      ...
      <ImageBackground
        ...
        style={styles.ImageBackground_1_1578}
      />
      <ImageBackground
        source={{
          uri:
      ...
      <ImageBackground
        ...
        style={styles.ImageBackground_51_52}
      />
...
const styles = StyleSheet.create({
  ...
  View_1_1567: {
    width: wp("100%"),
    minWidth: wp("100%"),
    height: hp("308.1967213114754%"),
    minHeight: hp("308.1967213114754%"),
    marginLeft: 0,
    marginTop: 0,
    position: "absolute",
    left: wp("0%"),
