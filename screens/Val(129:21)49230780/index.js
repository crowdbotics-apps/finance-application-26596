  ...
  render = () => (
    <ScrollView contentContainerStyle={{ flexGrow: 1 }}>
      <View style={styles.View_129_22}>
        ...
        />
        <View style={styles.View_129_24}>
          <View style={styles.View_129_25}>
            <View style={styles.View_129_26} />
            <View style={styles.View_129_27}>
              <Text style={styles.Text_129_27}>2018 Value : 1.5M</Text>
            </View>
          </View>
        </View>
      </View>
