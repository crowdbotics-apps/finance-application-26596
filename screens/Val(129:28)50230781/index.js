    ...
    <ScrollView contentContainerStyle={{ flexGrow: 1 }}>
      <View style={styles.View_129_29}>
        <ImageBackground
          ...
          style={styles.ImageBackground_129_30}
        />
        <View style={styles.View_129_31}>
          <View style={styles.View_129_32}>
            <View style={styles.View_129_33} />
            <View style={styles.View_129_34}>
              <Text style={styles.Text_129_34}>2017 Value : 1.2M</Text>
            </View>
          </View>
        </View>
      </View>
