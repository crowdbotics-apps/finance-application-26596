...
export class Blank extends React.Component {
  ...
  render = () => (
    <ScrollView contentContainerStyle={{ flexGrow: 1 }}>
      <View style={styles.View_129_8}>
        <ImageBackground
          source={{
            uri:
              "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/9956/fc71/31ad6a775b7435061632e147ffecfa38"
          }}
          style={styles.ImageBackground_129_9}
        />
        <View style={styles.View_129_10}>
          <View style={styles.View_129_11}>
            <View style={styles.View_129_12} />
            <View style={styles.View_129_13}>
              <Text style={styles.Text_129_13}>2020 Value : 1.95M</Text>
            </View>
          </View>
        </View>
      </View>
