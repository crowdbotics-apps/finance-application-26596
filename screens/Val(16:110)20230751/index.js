...
export class Blank extends React.Component {
  ...
  render = () => (
    <ScrollView contentContainerStyle={{ flexGrow: 1 }}>
      <View style={styles.View_16_111}>
        <ImageBackground
          source={{
            uri:
              "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/9956/fc71/31ad6a775b7435061632e147ffecfa38"
          }}
          style={styles.ImageBackground_16_112}
        />
        <View style={styles.View_16_113}>
          <View style={styles.View_16_114}>
            <View style={styles.View_16_115} />
            <View style={styles.View_16_116}>
              <Text style={styles.Text_16_116}>March Value : 1.2M</Text>
            </View>
          </View>
        </View>
      </View>
