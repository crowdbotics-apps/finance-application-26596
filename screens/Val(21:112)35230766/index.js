...
export class Blank extends React.Component {
  ...
  render = () => (
    <ScrollView contentContainerStyle={{ flexGrow: 1 }}>
      <View style={styles.View_21_113}>
        <ImageBackground
          source={{
            uri:
              "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/9956/fc71/31ad6a775b7435061632e147ffecfa38"
          }}
          style={styles.ImageBackground_21_114}
        />
        <View style={styles.View_21_115}>
          <View style={styles.View_21_116}>
            <View style={styles.View_21_117} />
            <View style={styles.View_21_118}>
              <Text style={styles.Text_21_118}>Expense Value : 2.0M</Text>
            </View>
          </View>
        </View>
      </View>
